...
const CStringDictionary::TStringId FORTE_QL::scmEventInputTypeIds[] = {g_nStringIdEInit, g_nStringIdEvent};
...
const CStringDictionary::TStringId FORTE_QL::scmEventOutputTypeIds[] = {g_nStringIdEInit, g_nStringIdEvent};
