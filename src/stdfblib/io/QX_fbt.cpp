...
const CStringDictionary::TStringId FORTE_QX::scmEventInputTypeIds[] = {g_nStringIdEInit, g_nStringIdEvent};
...
const CStringDictionary::TStringId FORTE_QX::scmEventOutputTypeIds[] = {g_nStringIdEInit, g_nStringIdEvent};
